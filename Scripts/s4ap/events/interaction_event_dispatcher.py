...
SINK_INTERACTIONS = {14241, 14238, 14240, 133052, 74885, 132167, 222271}
...
FRIDGE_INTERACTIONS = {13397, 100327, 13388, 13395}

COUNTER_INTERACTIONS = {13276, 13277, 13269, 13263, 13268, 269311}

STOVE_INTERACTIONS = {14337, 32043, 14343, 14343}

COOKING_INTERACTIONS = {13434, 13263, 13257}

KITCHEN_INTERACTIONS = {*FRIDGE_INTERACTIONS, *COUNTER_INTERACTIONS, *STOVE_INTERACTIONS}
...
BLOCKED_INTERACTIONS = {14428, *BATHROOM_INTERACTIONS, *KITCHEN_INTERACTIONS, *WORK_INTERACTIONS, *NEED_INTERACTIONS, *SLEEP_INTERACTIONS, *IDLE_INTERACTIONS, *COOKING_INTERACTIONS}
