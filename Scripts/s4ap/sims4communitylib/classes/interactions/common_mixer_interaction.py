...
class CommonMixerInteraction(MixerInteraction, HasClassLog, _CommonInteractionHooksMixin, _CommonInteractionCustomMixin):
    """CommonMixerInteraction(*_, **__)
    ...
    def _test(cls, target: Any, context: InteractionContext, super_interaction: 'Interaction'=None, skip_safe_tests: bool=False, **kwargs) -> CommonTestResult:
        ...
        try:
            try:
                ...
                verbose_log.format_with_message('Test Result (CommonMixerInteraction)', test_result=test_result)
            except Exception as ex:
                log.error('Error occurred while running CommonMixerInteraction \'{}\' on_test.'.format(cls.__name__), exception=ex)
            ...
            try:
                ...
                if verbose_log.enabled:
                    ...
                    if target is not None:
                        ...
                        target_result = None
                    verbose_log.format_with_message('Super Test Result (CommonMixerInteraction)', super_test_result=super_test_result, global_result=global_result, local_result=local_result, additional_local_result=additional_local_result, autonomous_result=autonomous_result, target_result=target_result)
            ...
            try:
                ...
                verbose_log.format_with_message('Post Test Result (CommonMixerInteraction)', post_super_test_result=post_super_test_result)
            except Exception as ex:
                log.error('Error occurred while running CommonMixerInteraction \'{}\' on_post_super_test.'.format(cls.__name__), exception=ex)
                return cls.create_test_result(False, f'An error occurred {ex}. See the log for more details. "The Sims 4/mod_logs/<mod_name>_Exceptions.txt"')
            ...
            log.error('Error occurred while running _test of CommonMixerInteraction \'{}\''.format(cls.__name__), exception=ex)
            return cls.create_test_result(False, f'An error occurred {ex}. See the log for more details. "The Sims 4/mod_logs/<mod_name>_Exceptions.txt"')
        finally:
            if verbose_log.enabled:
    ...
    def _trigger_interaction_start_event(self: 'CommonMixerInteraction'):
        try:
            ...
            self.log.error('Error occurred while running CommonMixerInteraction \'{}\' on_started.'.format(self.__class__.__name__), exception=ex)
    ...
    def apply_posture_state(self, posture_state: PostureState, participant_type: ParticipantType=ParticipantType.Actor, sim: Sim=DEFAULT):
        try:
            ...
            self.log.error('Error occurred while running CommonMixerInteraction \'{}\' modify_posture_state.'.format(self.__class__.__name__), exception=ex)
    ...
    def kill(self) -> bool:
        ...
        try:
            ...
            self.log.error('Error occurred while running CommonMixerInteraction \'{}\' on_killed.'.format(self.__class__.__name__), exception=ex)
        return super().kill()
    ...
    def cancel(self, finishing_type: FinishingType, cancel_reason_msg: str, **kwargs) -> bool:
        ...
        try:
            ...
            self.log.error('Error occurred while running CommonMixerInteraction \'{}\' cancel.'.format(self.__class__.__name__), exception=ex)
        return super().cancel(finishing_type, cancel_reason_msg, **kwargs)

    def on_reset(self: 'CommonMixerInteraction'):
        """on_reset()
        ...
        try:
            ...
            self.log.error('Error occurred while running CommonMixerInteraction \'{}\' on_reset.'.format(self.__class__.__name__), exception=ex)
        return super().on_reset()

    def _post_perform(self: 'CommonMixerInteraction'):
        ...
        try:
            ...
            self.log.error('Error occurred while running CommonMixerInteraction \'{}\' _post_perform.'.format(self.__class__.__name__), exception=ex)
        return super_result
    ...
    def send_current_progress(self, *args: Any, **kwargs: Any):
        ...
        try:
            ...
            self.log.error('Error occurred while running CommonMixerInteraction \'{}\' send_current_progress.'.format(self.__class__.__name__), exception=ex)
    ...
    def setup_asm_default(self, asm: NativeAsm, *args, **kwargs) -> bool:
        ...
        try:
            ...
            self.log.error('Error occurred while running CommonMixerInteraction \'{}\' setup_asm_default.'.format(self.__class__.__name__), exception=ex)
    ...
    def _constraint_gen(cls, sim: Sim, target: Any, participant_type: ParticipantType=ParticipantType.Actor, interaction: 'CommonMixerInteraction'=None) -> Constraint:
        ...
        try:
            ...
            cls.get_log().error('Error occurred while running CommonMixerInteraction \'{}\' _on_constraint_gen.'.format(cls.__name__), exception=ex)
