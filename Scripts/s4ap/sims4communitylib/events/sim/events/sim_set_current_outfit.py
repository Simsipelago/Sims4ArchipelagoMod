...
class S4CLSimSetCurrentOutfitEvent(CommonEvent):
    ...
    :param old_outfit_category_and_index: The outfit category and index for the outfit the Sim is changing from.
    :type old_outfit_category_and_index: Tuple[OutfitCategory, int]
    :param new_outfit_category_and_index: The outfit category and index for the outfit the Sim is changing to.
