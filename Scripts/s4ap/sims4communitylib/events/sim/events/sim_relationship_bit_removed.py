...
class S4CLSimRelationshipBitRemovedEvent(CommonEvent):
    """S4CLSimRelationshipBitRemovedEvent(sim_info_a, sim_info_b, relationship_bit)

    An event that occurs when a Relationship Bit is removed from Sim A to Sim B.
    ...
    .. code-block:: python
        ...
        class ExampleEventListener:
            ...
            def handle_event(event_data: S4CLSimRelationshipBitRemovedEvent):
                pass
    ...
    :param relationship_bit: The RelationshipBit that was removed.
    ...
    def relationship_bit(self) -> RelationshipBit:
        """The RelationshipBit that was removed.

        :return: The RelationshipBit that was removed.
