...
class S4CLSimTraitRemovedEvent(CommonEvent):
    """S4CLSimTraitRemovedEvent(sim_info, trait, trait_tracker)
    ...
    :type trait: Trait
    :param trait_tracker: The Trait Tracker being removed from.
    ...
    def sim_info(self) -> SimInfo:
        ...
        :return: The Sim that lost the trait.
        :rtype: SimInfo
        """
    ...
    def trait(self) -> Trait:
        ...
        :return: The Trait that was removed.
        :rtype: Trait
        """
        return self._trait
    ...
    def trait_tracker(self) -> TraitTracker:
        ...
        :return: The Trait Tracker being removed from.
        :rtype: TraitTracker
        """
