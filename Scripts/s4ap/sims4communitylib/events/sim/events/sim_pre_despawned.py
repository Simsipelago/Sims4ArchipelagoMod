...
class S4CLSimPreDespawnedEvent(CommonEvent):
    """S4CLSimPreDespawnedEvent(sim_info)
    ...
    :param sim_info: The Sim that is being despawned.
    ...
    def sim_info(self) -> SimInfo:
        ...
        :return: The Sim that is being despawned.
        :rtype: SimInfo
        """
