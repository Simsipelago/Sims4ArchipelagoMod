...
class S4CLGameObjectLoadedEvent(CommonEvent):
    """S4CLGameObjectLoadedEvent(game_object)
    ...
    :param game_object: The Game Object that was loaded.
    ...
    def game_object(self) -> GameObject:
        ...
        :return: The Game Object that was loaded.
        :rtype: GameObject
        """
