...
from s4ap.sims4communitylib.dialogs._common_ui_dialog_text_input_ok_cancel import _CommonUiDialogTextInputOkCancel
...
@CommonConsoleCommand(
    ...
    's4clib_testing.show_input_float_dialog',
    'Show an example of CommonInputFloatDialog.'
)
def _common_testing_show_input_float_dialog(output: CommonConsoleCommandOutput):
