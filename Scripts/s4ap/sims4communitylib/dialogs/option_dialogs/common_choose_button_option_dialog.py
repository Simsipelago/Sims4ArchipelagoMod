...
from s4ap.sims4communitylib.dialogs.option_dialogs.common_choose_response_option_dialog import \
    CommonChooseResponseOptionDialog
from s4ap.sims4communitylib.dialogs.option_dialogs.options.response.common_dialog_button_option import \
...
from s4ap.sims4communitylib.services.commands.common_console_command_parameters import \
