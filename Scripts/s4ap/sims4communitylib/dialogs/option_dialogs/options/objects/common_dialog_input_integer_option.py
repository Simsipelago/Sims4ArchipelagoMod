...
from s4ap.sims4communitylib.dialogs.common_input_integer_dialog import CommonInputIntegerDialog
...
class CommonDialogInputIntegerOption(CommonDialogObjectOption):
    ...
    def __init__(
        ...
        on_chosen: Callable[[DialogOptionIdentifierType, int, CommonChoiceOutcome], None]=CommonFunctionUtils.noop,
        ...
        self._dialog = CommonInputIntegerDialog(
            context.title,
            dialog_description,
            initial_value,
            min_value=min_value,
        ...
        def _on_submit(_: int, __: CommonChoiceOutcome):
