...
from s4ap.sims4communitylib.dialogs.common_input_multi_text_dialog import CommonInputMultiTextDialog
...
class CommonDialogInputMultiTextOption(CommonDialogObjectOption):
    """CommonDialogInputMultiTextOption(\
        mod_identity,\
        option_identifier,\
        input_fields,\
        context,\
    ...
    :param input_fields: An iterator of input fields to display in the dialog when the option is chosen.
    ...
    def __init__(
        ...
        on_chosen: Callable[[DialogOptionIdentifierType, Dict[str, str], CommonChoiceOutcome], None]=CommonFunctionUtils.noop,
        ...
        self._dialog = CommonInputMultiTextDialog(
            mod_identity,
            context.title,
            dialog_description,
            input_fields
        ...
        def _on_submit(_: Dict[str, str], __: CommonChoiceOutcome):
