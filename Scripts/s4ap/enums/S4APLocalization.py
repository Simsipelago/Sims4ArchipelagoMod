...
careers_list = [
    ...
    "Concierto Virtuoso (Entertainer / Musician 10)",
    ...
    "Master of the Real (Painter / Patron of the Arts 10)",
    ...
    "Personal Re-Imager (Style Influencer / Stylist 10)",
    ...
    "Editor-in-Chef (Writer / Journalist 9)",
